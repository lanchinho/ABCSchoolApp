...
public static class ResponseWrapperExtensions
{
    ...
    public static async Task<IResponseWrapper<T>> WrapToResponseForStructs<T>(this HttpResponseMessage responseMessage)
        where T : struct
    {
        var responseAsString = await responseMessage.Content.ReadAsStringAsync();
        var responseObject = JsonSerializer.Deserialize<ResponseWrapperForStruct<T>>(responseAsString, options);
        return responseObject;
    }
